...
<div class="container mx-auto p-4">
  ...
  <form class="grid grid-cols-1 gap-6" method="POST" action="{{ route('admin.updateRole', $role->id) }}">
    ...
    <div class="p-2">
        ...
        <input value="{{ old('name', $role->name) }}" type="text" id="name" name="name" required class="block w-full rounded-md border-gray-300 shadow-sm p-2 border-2" style="background-color: #f6f6f6;">
    </div>
